...
public class Joc {
	...
	public static void joc() {
		...
		do {
			ok = jugar(/*jug1Sol, jug1Secret,*/ maq1Sol, maq1Secret, TAB);
			if (ok != true) {
	 ...
	 * 		</ul>
	 */
	public static boolean jugar(/*char[][] jug1Sol, char[][] jug1Secret,*/ char[][] maq1Sol, char[][] maq1Secret, int TAB) {
		int Player = 1; //def 2
		boolean ok = false;
		do {
			//Player = (Player % 2) + 1;
			...
			case 1:
				...
				Player++; //para la version de 1 jugador
				break;
			case 2:
				//ok = Tiradas.MaqARM(jug1Sol, jug1Secret, TAB, Player);
				break;
			}
